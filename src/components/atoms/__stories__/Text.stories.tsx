...
export const Hero: Story<TextProps> = (args) => <Text {...args} />;
Hero.args = { as: 'h1', children: 'There goes my hero', textStyle: 'hero' };

export const H1: Story<TextProps> = (args) => <Text {...args} />;
H1.args = { as: 'h1', children: 'This is h1 Text', textStyle: 'h1' };

export const H2: Story<TextProps> = (args) => <Text {...args} />;
H2.args = { as: 'h2', children: 'This is h2 Text', textStyle: 'h2' };

export const H3: Story<TextProps> = (args) => <Text {...args} />;
H3.args = { as: 'h3', children: 'This is h3 Text', textStyle: 'h3' };

export const P: Story<TextProps> = (args) => (
  <Text {...args} style={{ maxWidth: '24rem' }} />
);
P.args = {
  children:
...
export const PreHeading: Story<TextProps> = (args) => <Text {...args} />;
PreHeading.args = {
